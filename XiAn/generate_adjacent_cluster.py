...
if __name__ == '__main__':
    ...
    parser.add_argument('--sensor_ids_filename', type=str, default='data/xian/graph_sensor_cluster_ids.txt',
                        help='File containing sensor ids separated by comma.')
    parser.add_argument('--distances_filename', type=str, default='data/xian/distance_cluster.csv',
                        help='CSV file containing sensor distances with three columns: [from, to, distance].')
    parser.add_argument('--output_pkl_filename', type=str, default='data/XiAn_City/adj_mat_cluster.pkl',
    ...
    np.save("data/XiAn_City/adj_mat_cluster.npy",adj_mx)
