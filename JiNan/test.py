...
def main():
    ...
    if args.model=='COGCN':
        engine = trainer1( args.in_dim, args.seq_length, args.num_nodes, args.nhid, args.CL,args.dropout,
    ...
    #testing
    engine.model.load_state_dict(torch.load(params_path+"/"+args.model+"_exp1_best_2.85"+".pth")) #relplace COGCN:2.83 COGCN_NL:2.85
