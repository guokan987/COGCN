...
if __name__ == '__main__':
    ...
    parser.add_argument('--sensor_ids_filename', type=str, default='data/jinan/graph_sensor_ids.txt',
                        help='File containing sensor ids separated by comma.')
    parser.add_argument('--distances_filename', type=str, default='data/jinan/distance.csv',
                        help='CSV file containing sensor distances with three columns: [from, to, distance].')
    parser.add_argument('--output_pkl_filename', type=str, default='data/JiNan_City/adj_mat.pkl',
    ...
    np.save("data/JiNan_City/adj_mat.npy",adj_mx)
