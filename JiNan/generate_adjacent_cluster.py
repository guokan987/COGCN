# -*- coding: utf-8 -*-
"""
Created on Thu Jun 11 19:35:03 2020
...
if __name__ == '__main__':
    ...
    parser.add_argument('--sensor_ids_filename', type=str, default='data/jinan/graph_sensor_cluster_ids.txt',
                        help='File containing sensor ids separated by comma.')
    parser.add_argument('--distances_filename', type=str, default='data/jinan/distance_cluster.csv',
                        help='CSV file containing sensor distances with three columns: [from, to, distance].')
    parser.add_argument('--output_pkl_filename', type=str, default='data/JiNan_City/adj_mat_cluster.pkl',
    ...
    np.save("data/JiNan_City/adj_mat_cluster.npy",adj_mx)
