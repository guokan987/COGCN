# -*- coding: utf-8 -*-
"""
Created on Sat Feb  1 15:01:20 2020
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default="data/JiNan_City", help="Output directory.")
    parser.add_argument("--traffic_df_filename", type=str, default="data/jinan/original_data.npz", help="Raw traffic readings.",)
